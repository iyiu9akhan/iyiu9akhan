...
<p align="left">Results-oriented Web Developer with 2+ years of hand-on experience in building full-stack web applications using the MERN Stack ( MongoDB , ExpressJS , React , NodeJS ) . My curiosity extends to AI, Web technologies and innovative software solutions, where i constantly explore ways to merge cutting-edge tech with real-world impact.</p>
